...
/* 进入工分登记界面的六种方式 */
typedef NS_ENUM (NSInteger,ENTER_POINTREG_TYPE){
    ENTER_POINTREG_TYPE_PERSON = 1,
    ENTER_POINTREG_TYPE_CHARGE,
    ENTER_POINTREG_TYPE_LEADER,
    ENTER_POINTREG_TYPE_PERSON_AUDIT,
    ENTER_POINTREG_TYPE_CHARGE_AUDIT,
    ENTER_POINTREG_TYPE_LEADER_AUDIT,    
};
